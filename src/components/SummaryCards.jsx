...
const SummaryCards = ({ data }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <Card title="Total Projectors Deployed" value={data.total} color="purple" />
      <Card title="Reporting Projectors" value={data.reporting} color="green" />
      <Card title="Not Reporting" value={data.notReporting} color="red" />
    </div>
  );
};
